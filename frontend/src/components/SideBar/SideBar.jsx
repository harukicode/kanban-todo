	...
	return (
		<Sidebar className="w-64 h-screen bg-white border-r border-gray-200 shadow-md flex flex-col">
			...
			<SidebarContent className="px-3 py-0 flex-grow overflow-y-auto">
				...
				<SidebarGroup>
					<h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3 px-3">My Projects</h3>
					<SidebarMenu>
			...
			<SidebarFooter className="p-3 border-t border-gray-200">
				...
				<Button className="w-full rounded-lg border-gray-300 text-gray-700 hover:bg-gray-100 text-sm py-2" variant="outline">
